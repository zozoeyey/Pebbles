import type { Activity, ExploreAct, PeerReflection, ActConfig } from '../types';
...
export const ACT_CONFIGS: Record<string, ActConfig> = {
  ...
  'wiggle-cool-down': {
    ...
    steps: [
      ...
      'Wiggle it out (10, 9, 8). Both of you stand up and wiggle your whole bodies, making silly noises — the sillier the better.',
      'Start quieting down (7, 6). Keep moving, but drop your voice to a whisper as you count.',
      'Sit down and go silent (5, 4). Sit down together and stop talking completely.',
      'Breathe and settle (3, 2, 1, 0). At 3, take a deep breath and roll your shoulders back. At 2, take another deep breath and cover your eyes. Count down through 1 and 0.',
      'Open your eyes and check in. Ask: "How did you feel as we went from fast and wiggly to slow and calm? Was there a moment when you felt yourself relax?"',
    ],
    stepImgs: [
