      ...
      <div className="toolkit-wrap">
        ...
        <div className="toolkit-stat-row">
          ...
          <div className="toolkit-stat-card">
            ...
            <svg className="toolkit-stat-deco" style={{ width: 76, height: 76, right: -20, top: -16 }} viewBox="0 0 170 170" fill="none">
              ...
              <ellipse cx="92" cy="72" rx="7" ry="9" fill="#666"/>
              <ellipse cx="116" cy="72" rx="7" ry="9" fill="#666"/>
            </svg>
          </div>
        </div>
        <div className="toolkit-stat-row">
